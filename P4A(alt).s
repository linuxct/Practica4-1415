...
reiniciar:        
	...
	add $t7,$a0,$0		# "copiamos" el contador de programa a t7 para no perderlo al hacer una salida por pantalla
	la $a0,newline		# cargamos newline para mostrarlo por pantalla
	li $v0,4			# escribe cadena de texto
	syscall				# llamada al sistema
	add $a0,$t7,$0		# "copiamos" de nuevo el valor de t7 (contador de programa) a a0
...
repetirrutina:              
	...
	add $t6,$a0,$0		# "copiamos" a0 a t6 para no perderlo al hacer una salida por pantalla
	la $a0,esp			# cargamos esp para mostrarla por pantalla
	li $v0,4			# escribe cadena de texto
	syscall				# llamada al sistema
	add $a0,$t6,$0		# "copiamos" t6 a a0
